...
- 복사 대상: `<repo>/.claude/`
- 대상 파일: `MEMORY.md`, `can_package.md`, `project_build.md`, `user_style.md`, `siheung_map_senario3.md`, `web_hmi_adapt_harness.md`, `web_hmi_adapt_pitfalls.md`, `feedback_no_japanese.md`, `project_qt_hmi.md`, `project_bag_replay_hmi.md`, `project_bridge_cpp_port.md` (메모리 파일 추가 시 갱신)
