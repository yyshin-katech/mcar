...
- [mqtt-vpn-setup 하네스 + 실 환경 검증](mqtt_vpn_setup_harness.md) — kanavi VPN split-tunnel (실 환경=SecuwaySSL/Secuwiz, OpenVPN 아님). `/home/katech/sslvpn/SecuwaySSLU_client` + `client.info`(27.101.133.111:443). tun0=172.18.113.51, split push 자동. prod MQTT (192.168.255.173:10044) ↔ `/siheung_v2x/mqtt_spat` 5Hz 검증. IID 517(시화) signalGroup 60/80. publishSpat 필터 `/localization/to_control_team`. 다른 PC 셋업 산출물: `tools/sslvpn/SSU21-2.1.0.2-20230331.tgz` + `tools/sslvpn/README.md`
