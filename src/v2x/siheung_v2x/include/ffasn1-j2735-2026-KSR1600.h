...
#ifndef _FFASN1_FFASN1_J2735_2026_H
#define _FFASN1_FFASN1_J2735_2026_H
...
typedef struct j2735SignalControlZone {
  j2735RegionalExtension_32 zone;
...
typedef enum j2735PersonalDeviceUserType {
  ...
  j2735PersonalDeviceUserType_aWheelchair,
  j2735PersonalDeviceUserType_aSelfBalancingDevice,
  j2735PersonalDeviceUserType_aStandingScooter,
  j2735PersonalDeviceUserType_aSeatedScooter,
  j2735PersonalDeviceUserType_aSkates,
  j2735PersonalDeviceUserType_anOneWheelTransporter,
  j2735PersonalDeviceUserType_aCargoBike,
  j2735PersonalDeviceUserType_aConstructionWorker,
  j2735PersonalDeviceUserType_anOther,
...
typedef enum {
  j2735TrafficLightID_id,
  j2735TrafficLightID_oid,
} j2735TrafficLightID_choice;

typedef struct j2735TrafficLightID {
  j2735TrafficLightID_choice choice;
  union {
    ASN1Integer id;
...
extern const ASN1CType asn1_type_j2735TrafficLightID[];

typedef ASN1BitString j2735TrafficLightOperationStatus;

extern const ASN1CType asn1_type_j2735TrafficLightOperationStatus[];

typedef ASN1BitString j2735TrafficLightControllerStatus;

extern const ASN1CType asn1_type_j2735TrafficLightControllerStatus[];

typedef int j2735TimeInSecond_B16;

extern const ASN1CType asn1_type_j2735TimeInSecond_B16[];

typedef enum j2735TrafficLightType {
  j2735TrafficLightType_reserved,
  j2735TrafficLightType_straight,
  j2735TrafficLightType_left_turn,
  j2735TrafficLightType_pedestrian,
  j2735TrafficLightType_bicycle,
  j2735TrafficLightType_right_turn,
  j2735TrafficLightType_bus,
  j2735TrafficLightType_u_turn,
} j2735TrafficLightType;

extern const ASN1CType asn1_type_j2735TrafficLightType[];

typedef enum j2735ConsecutiveTrafficLight {
  j2735ConsecutiveTrafficLight_none,
  j2735ConsecutiveTrafficLight_first,
  j2735ConsecutiveTrafficLight_second,
} j2735ConsecutiveTrafficLight;

extern const ASN1CType asn1_type_j2735ConsecutiveTrafficLight[];

typedef enum j2735TrafficLightIntervalType {
  j2735TrafficLightIntervalType_Static,
  j2735TrafficLightIntervalType_variable,
} j2735TrafficLightIntervalType;

extern const ASN1CType asn1_type_j2735TrafficLightIntervalType[];

typedef BOOL j2735PedestrianCall;

extern const ASN1CType asn1_type_j2735PedestrianCall[];

typedef BOOL j2735ActuatedInterval;

extern const ASN1CType asn1_type_j2735ActuatedInterval[];

typedef enum j2735PermissiveNonProtected {
  j2735PermissiveNonProtected_none,
  j2735PermissiveNonProtected_permissive,
} j2735PermissiveNonProtected;

extern const ASN1CType asn1_type_j2735PermissiveNonProtected[];

typedef enum j2735TrafficLightingStatus {
  j2735TrafficLightingStatus_off,
  j2735TrafficLightingStatus_red_on,
  j2735TrafficLightingStatus_yellow_on,
  j2735TrafficLightingStatus_green_on,
  j2735TrafficLightingStatus_red_blinking,
  j2735TrafficLightingStatus_yellow_blinking,
  j2735TrafficLightingStatus_green_blinking,
} j2735TrafficLightingStatus;

extern const ASN1CType asn1_type_j2735TrafficLightingStatus[];

typedef int j2735TimeInSecond_B8;

extern const ASN1CType asn1_type_j2735TimeInSecond_B8[];

typedef int j2735TrafficLightDirectionCode;

extern const ASN1CType asn1_type_j2735TrafficLightDirectionCode[];

typedef BOOL j2735ReservedBit;

extern const ASN1CType asn1_type_j2735ReservedBit[];

typedef struct j2735TrafficLightStatus {
  j2735TrafficLightType trafficLightType;
  j2735ConsecutiveTrafficLight consecutiveTrafficLight;
  j2735TrafficLightIntervalType trafficLightIntervalType;
  j2735PedestrianCall pedestrianCall;
  j2735ActuatedInterval actuatedinterval;
  j2735PermissiveNonProtected permissiveNonProtected;
  j2735TrafficLightingStatus lightingStatus;
  j2735TimeInSecond_B8 maxIntervalLength;
  j2735TimeInSecond_B8 remainingTime;
  j2735TrafficLightDirectionCode directionCode;
  j2735ReservedBit reserved;
} j2735TrafficLightStatus;


extern const ASN1CType asn1_type_j2735TrafficLightStatus[];

typedef struct j2735TrafficLightStatusList {
  j2735TrafficLightStatus *tab;
  size_t count;
} j2735TrafficLightStatusList;

extern const ASN1CType asn1_type_j2735TrafficLightStatusList[];

typedef struct j2735TrafficLightStatusMessage {
  j2735TrafficLightID traffiLightID;
  BOOL Long_option;
  j2735Longitude Long;
  BOOL lat_option;
  j2735Latitude lat;
  j2735TrafficLightOperationStatus operationStatus;
  j2735TrafficLightControllerStatus controllerStatus;
  j2735TimeInSecond_B16 cycleCounter;
  j2735TimeInSecond_B16 cycleTime;
  j2735DDateTime currentTime;
  j2735TrafficLightStatusList trafficLightStatus;
} j2735TrafficLightStatusMessage;


extern const ASN1CType asn1_type_j2735TrafficLightStatusMessage[];
...
typedef struct j2735RequestorType {
  ...
  j2735VehicleType hpmsType;
  BOOL regional_option;
  j2735RegionalExtension_34 regional;
} j2735RequestorType;
...
typedef int j2735ITISCodes_KOR;

extern const ASN1CType asn1_type_j2735ITISCodes_KOR[];

typedef struct j2735EventDescription_KOR {
  j2735ITISCodes_KOR eventType;
} j2735EventDescription_KOR;


extern const ASN1CType asn1_type_j2735EventDescription_KOR[];

typedef enum j2735DectLane_KOR {
  j2735DectLane_KOR_unavailable,
  j2735DectLane_KOR_busOnlyLane,
  j2735DectLane_KOR_ctrBusLane,
  j2735DectLane_KOR_rdSdBusLane,
  j2735DectLane_KOR_mergingLane,
  j2735DectLane_KOR_accelerationLane,
  j2735DectLane_KOR_decelrationLane,
  j2735DectLane_KOR_rampLane,
  j2735DectLane_KOR_shoulderLane,
  j2735DectLane_KOR_carLane,
  j2735DectLane_KOR_car_1stLane,
  j2735DectLane_KOR_car_2ndLane,
  j2735DectLane_KOR_car_3rdLane,
  j2735DectLane_KOR_car_4thLane,
  j2735DectLane_KOR_car_5thLane,
  j2735DectLane_KOR_car_6thLane,
  j2735DectLane_KOR_car_7thLane,
  j2735DectLane_KOR_car_8thLane,
  j2735DectLane_KOR_car_9thLane,
  j2735DectLane_KOR_car_10thLane,
  j2735DectLane_KOR_car_11thLane,
  j2735DectLane_KOR_car_12thLane,
  j2735DectLane_KOR_car_13thLane,
  j2735DectLane_KOR_car_14thLane,
  j2735DectLane_KOR_car_15thLane,
  j2735DectLane_KOR_car_16thLane,
  j2735DectLane_KOR_car_17thLane,
  j2735DectLane_KOR_car_18thLane,
  j2735DectLane_KOR_car_19thLane,
  j2735DectLane_KOR_car_20thLane,
  j2735DectLane_KOR_etcLane,
} j2735DectLane_KOR;

extern const ASN1CType asn1_type_j2735DectLane_KOR[];

typedef enum {
  j2735RegionDescribedByID_KOR_laneID,
  j2735RegionDescribedByID_KOR_segmentID,
  j2735RegionDescribedByID_KOR_linkID,
  j2735RegionDescribedByID_KOR_detectLane,
  j2735RegionDescribedByID_KOR_areaID,
  j2735RegionDescribedByID_KOR_intersections,
} j2735RegionDescribedByID_KOR_choice;

typedef struct j2735RegionDescribedByID_KOR {
  j2735RegionDescribedByID_KOR_choice choice;
  union {
    j2735LaneID laneID;
    j2735RoadSegmentID segmentID;
    ASN1String linkID;
    j2735DectLane_KOR detectLane;
    ASN1String areaID;
    j2735IntersectionID intersections;
  } u;
} j2735RegionDescribedByID_KOR;

extern const ASN1CType asn1_type_j2735RegionDescribedByID_KOR[];

typedef struct j2735GeographicalPath_KOR_1 {
  j2735RegionDescribedByID_KOR *tab;
  size_t count;
} j2735GeographicalPath_KOR_1;

extern const ASN1CType asn1_type_j2735GeographicalPath_KOR_1[];

typedef struct j2735GeographicalPath_KOR {
  j2735GeographicalPath_KOR_1 regions;
} j2735GeographicalPath_KOR;


extern const ASN1CType asn1_type_j2735GeographicalPath_KOR[];

typedef enum j2735BasicVehicleClass_KOR {
  j2735BasicVehicleClass_KOR_unknown,
  j2735BasicVehicleClass_KOR_passenger_vehicle_tiny,
  j2735BasicVehicleClass_KOR_passenger_vehicle_mini,
  j2735BasicVehicleClass_KOR_passenger_vehicle_small,
  j2735BasicVehicleClass_KOR_passenger_vehicle_medium,
  j2735BasicVehicleClass_KOR_passenger_vehicle_fullsize,
  j2735BasicVehicleClass_KOR_van_mini,
  j2735BasicVehicleClass_KOR_van_small,
  j2735BasicVehicleClass_KOR_van_medium,
  j2735BasicVehicleClass_KOR_van_fullsize,
  j2735BasicVehicleClass_KOR_truck_tiny,
  j2735BasicVehicleClass_KOR_truck_mini,
  j2735BasicVehicleClass_KOR_truck_small_A,
  j2735BasicVehicleClass_KOR_truck_small_B,
  j2735BasicVehicleClass_KOR_truck_medium_A,
  j2735BasicVehicleClass_KOR_truck_medium_B,
  j2735BasicVehicleClass_KOR_truck_medium_C,
  j2735BasicVehicleClass_KOR_truck_fullsize_A,
  j2735BasicVehicleClass_KOR_truck_fullsize_B,
  j2735BasicVehicleClass_KOR_truck_fullsize_C,
  j2735BasicVehicleClass_KOR_truck_fullsize_D,
  j2735BasicVehicleClass_KOR_truck_fullsize_E,
  j2735BasicVehicleClass_KOR_special_vehicle_mini,
  j2735BasicVehicleClass_KOR_special_vehicle_small,
  j2735BasicVehicleClass_KOR_special_vehicle_medium,
  j2735BasicVehicleClass_KOR_special_vehicle_fullsize,
  j2735BasicVehicleClass_KOR_motorcycle_mini,
  j2735BasicVehicleClass_KOR_motorcycle_small,
  j2735BasicVehicleClass_KOR_motorcycle_medium,
  j2735BasicVehicleClass_KOR_motorcycle_fullsize,
  j2735BasicVehicleClass_KOR_heavy_equipment,
  j2735BasicVehicleClass_KOR_motorcycle_tiny,
  j2735BasicVehicleClass_KOR_motorized_bicycle,
  j2735BasicVehicleClass_KOR_personal_mobility_kickboard,
  j2735BasicVehicleClass_KOR_personal_mobility_segway,
  j2735BasicVehicleClass_KOR_personal_mobility_throttle_bicycle,
  j2735BasicVehicleClass_KOR_bicycle_general,
  j2735BasicVehicleClass_KOR_bicycle_pas,
  j2735BasicVehicleClass_KOR_horse_cattle,
  j2735BasicVehicleClass_KOR_tram,
  j2735BasicVehicleClass_KOR_pedestrian,
  j2735BasicVehicleClass_KOR_etc,
} j2735BasicVehicleClass_KOR;

extern const ASN1CType asn1_type_j2735BasicVehicleClass_KOR[];

typedef struct j2735SupplementalVehicleExtensions_KOR {
  j2735BasicVehicleClass_KOR vehicleClass;
} j2735SupplementalVehicleExtensions_KOR;


extern const ASN1CType asn1_type_j2735SupplementalVehicleExtensions_KOR[];

typedef enum j2735BasicVehicleRole_KOR {
  j2735BasicVehicleRole_KOR_unknown,
  j2735BasicVehicleRole_KOR_general_passenger_vehicle,
  j2735BasicVehicleRole_KOR_general_school_bus,
  j2735BasicVehicleRole_KOR_general_bicycle,
  j2735BasicVehicleRole_KOR_general_motorcycle,
  j2735BasicVehicleRole_KOR_general_heavy_equipment,
  j2735BasicVehicleRole_KOR_general_vehicle_with_trailer,
  j2735BasicVehicleRole_KOR_general_pedestrian,
  j2735BasicVehicleRole_KOR_general_personal_mobility,
  j2735BasicVehicleRole_KOR_general_farming_vehicle,
  j2735BasicVehicleRole_KOR_general_recreational_vehicle,
  j2735BasicVehicleRole_KOR_general_etc,
  j2735BasicVehicleRole_KOR_general_unknown,
  j2735BasicVehicleRole_KOR_emergency_police,
  j2735BasicVehicleRole_KOR_emergency_fire,
  j2735BasicVehicleRole_KOR_emergency_ambulance,
  j2735BasicVehicleRole_KOR_emergency_hazmat,
  j2735BasicVehicleRole_KOR_emergency_military,
  j2735BasicVehicleRole_KOR_emergency_prosecutor,
  j2735BasicVehicleRole_KOR_emergency_prison,
  j2735BasicVehicleRole_KOR_emergency_gov_affairs,
  j2735BasicVehicleRole_KOR_emergency_pub_affairs,
  j2735BasicVehicleRole_KOR_emergency_civil_defense,
  j2735BasicVehicleRole_KOR_emergency_post,
  j2735BasicVehicleRole_KOR_emerency_etc,
  j2735BasicVehicleRole_KOR_public_transport_bus,
  j2735BasicVehicleRole_KOR_public_transport_taxi,
  j2735BasicVehicleRole_KOR_public_transport_tram,
  j2735BasicVehicleRole_KOR_roadmgmt_construction_vehicle,
  j2735BasicVehicleRole_KOR_roadmgmt_snow_plow,
  j2735BasicVehicleRole_KOR_roadmgmt_brush_vehicle,
  j2735BasicVehicleRole_KOR_roadmgmt_road_rescue,
  j2735BasicVehicleRole_KOR_truck,
  j2735BasicVehicleRole_KOR_oversize_truck,
  j2735BasicVehicleRole_KOR_overweight_truck,
} j2735BasicVehicleRole_KOR;

extern const ASN1CType asn1_type_j2735BasicVehicleRole_KOR[];

typedef struct j2735VehicleClassification_KOR {
  BOOL role_option;
  j2735BasicVehicleRole_KOR role;
} j2735VehicleClassification_KOR;


extern const ASN1CType asn1_type_j2735VehicleClassification_KOR[];

typedef enum j2735ADASEventType_KOR {
  j2735ADASEventType_KOR_nowarning,
  j2735ADASEventType_KOR_bus,
  j2735ADASEventType_KOR_car,
  j2735ADASEventType_KOR_truck,
  j2735ADASEventType_KOR_motors,
  j2735ADASEventType_KOR_special,
  j2735ADASEventType_KOR_bicycle,
  j2735ADASEventType_KOR_pedestrian,
  j2735ADASEventType_KOR_pothole,
  j2735ADASEventType_KOR_rubbercon,
  j2735ADASEventType_KOR_ldwsLeft,
  j2735ADASEventType_KOR_ldwsRight,
  j2735ADASEventType_KOR_ldwsWarning,
} j2735ADASEventType_KOR;

extern const ASN1CType asn1_type_j2735ADASEventType_KOR[];

typedef struct j2735CITSADAS_KOR {
  j2735ADASEventType_KOR event;
  BOOL distance_option;
  j2735ObstacleDistance distance;
  BOOL time_option;
  j2735DSecond time;
  BOOL Long_option;
  j2735Longitude Long;
  ...
  j2735Latitude lat;
  BOOL confidence_option;
  j2735PositionConfidence confidence;
} j2735CITSADAS_KOR;


extern const ASN1CType asn1_type_j2735CITSADAS_KOR[];

typedef struct j2735BasicSafetyMessage_KOR_1 {
  j2735CITSADAS_KOR *tab;
  size_t count;
} j2735BasicSafetyMessage_KOR_1;

extern const ASN1CType asn1_type_j2735BasicSafetyMessage_KOR_1[];

typedef int j2735VerticalHeading_KOR;

extern const ASN1CType asn1_type_j2735VerticalHeading_KOR[];

typedef enum j2735BrakePedalCmd_KOR {
  j2735BrakePedalCmd_KOR_off,
  j2735BrakePedalCmd_KOR_on,
} j2735BrakePedalCmd_KOR;

extern const ASN1CType asn1_type_j2735BrakePedalCmd_KOR[];

typedef int j2735BrakePedalPressure_KOR;

extern const ASN1CType asn1_type_j2735BrakePedalPressure_KOR[];

typedef ASN1BitString j2735VehicleEventFlags_KOR;

extern const ASN1CType asn1_type_j2735VehicleEventFlags_KOR[];

typedef struct j2735WheelAngles_KOR {
  BOOL flWheelAngle_option;
  j2735DrivingWheelAngle flWheelAngle;
  BOOL frWheelAngle_option;
  j2735DrivingWheelAngle frWheelAngle;
  BOOL rlWheelAngle_option;
  j2735DrivingWheelAngle rlWheelAngle;
  BOOL rrWheelAngle_option;
  j2735DrivingWheelAngle rrWheelAngle;
} j2735WheelAngles_KOR;


extern const ASN1CType asn1_type_j2735WheelAngles_KOR[];

typedef enum j2735ResponseType_KOR {
  j2735ResponseType_KOR_not_in_use,
  j2735ResponseType_KOR_emergency,
  j2735ResponseType_KOR_non_emergency,
  j2735ResponseType_KOR_emergency_in_drill,
  j2735ResponseType_KOR_emergency_pursuit,
  j2735ResponseType_KOR_emergency_stationary,
  j2735ResponseType_KOR_emergency_slow_moving,
  j2735ResponseType_KOR_emergency_stop_go,
} j2735ResponseType_KOR;

extern const ASN1CType asn1_type_j2735ResponseType_KOR[];

typedef struct j2735BasicSafetyMessage_KOR {
  BOOL adas_option;
  j2735BasicSafetyMessage_KOR_1 adas;
  BOOL typeEvent_option;
  j2735ITIScodes typeEvent;
  BOOL laneID_option;
  j2735LaneID laneID;
  BOOL roadSegmentRef_option;
  j2735RoadSegmentReferenceID roadSegmentRef;
  BOOL dectLane_option;
  j2735DectLane_KOR dectLane;
  BOOL verticalHeading_option;
  j2735VerticalHeading_KOR verticalHeading;
  BOOL brakePedalCmd_option;
  j2735BrakePedalCmd_KOR brakePedalCmd;
  BOOL brakePedalPressure_option;
  j2735BrakePedalPressure_KOR brakePedalPressure;
  BOOL eventFlags_option;
  j2735VehicleEventFlags_KOR eventFlags;
  BOOL wheelAngle_option;
  j2735WheelAngles_KOR wheelAngle;
  BOOL responseType_option;
  j2735ResponseType_KOR responseType;
} j2735BasicSafetyMessage_KOR;


extern const ASN1CType asn1_type_j2735BasicSafetyMessage_KOR[];

typedef struct j2735EmergencyVehicleAlert_KOR {
  j2735ITISCodes_KOR typeEvent;
  BOOL heading_option;
  j2735Heading heading;
  BOOL extent_option;
  j2735Extent extent;
  BOOL position_option;
  j2735FullPositionVector position;
} j2735EmergencyVehicleAlert_KOR;


extern const ASN1CType asn1_type_j2735EmergencyVehicleAlert_KOR[];

typedef struct j2735PathPlannedPoint_KOR {
  j2735OffsetLL_B18 latOffset;
  j2735OffsetLL_B18 lonOffset;
  j2735VertOffset_B12 elevationOffset;
  j2735TimeOffset timeOffset;
  BOOL positionalAccuracy_option;
  j2735PositionalAccuracy positionalAccuracy;
  BOOL heading_option;
  j2735CoarseHeading heading;
} j2735PathPlannedPoint_KOR;


extern const ASN1CType asn1_type_j2735PathPlannedPoint_KOR[];

typedef struct j2735PathPlannedPointList_KOR {
  j2735PathPlannedPoint_KOR *tab;
  size_t count;
} j2735PathPlannedPointList_KOR;

extern const ASN1CType asn1_type_j2735PathPlannedPointList_KOR[];

typedef struct j2735PathPlanned_KOR {
  BOOL initialPosition_option;
  j2735FullPositionVector initialPosition;
  BOOL currGNSSstatue_option;
  j2735GNSSstatus currGNSSstatue;
  j2735PathPlannedPointList_KOR pathPlanned;
} j2735PathPlanned_KOR;


extern const ASN1CType asn1_type_j2735PathPlanned_KOR[];

typedef struct j2735IntersectionCollisionAvoidance_KOR {
  BOOL path_option;
  j2735PathPlanned_KOR path;
} j2735IntersectionCollisionAvoidance_KOR;


extern const ASN1CType asn1_type_j2735IntersectionCollisionAvoidance_KOR[];

typedef enum j2735HumanDriverStatus_KOR {
  j2735HumanDriverStatus_KOR_frontEyeOut,
  j2735HumanDriverStatus_KOR_drowsyLight,
  j2735HumanDriverStatus_KOR_drowsySerious,
  j2735HumanDriverStatus_KOR_faceOut,
  j2735HumanDriverStatus_KOR_smoking,
  j2735HumanDriverStatus_KOR_phone,
  j2735HumanDriverStatus_KOR_yawn,
} j2735HumanDriverStatus_KOR;

extern const ASN1CType asn1_type_j2735HumanDriverStatus_KOR[];

typedef ASN1BitString j2735DeviceStatus_KOR;

extern const ASN1CType asn1_type_j2735DeviceStatus_KOR[];

typedef struct j2735RoadWorkInfo_KOR_1 {
  j2735LaneID *tab;
  size_t count;
} j2735RoadWorkInfo_KOR_1;

extern const ASN1CType asn1_type_j2735RoadWorkInfo_KOR_1[];

typedef struct j2735RoadWorkInfo_KOR {
  BOOL worklanes_option;
  j2735RoadWorkInfo_KOR_1 worklanes;
  BOOL workstart_option;
  j2735DDateTime workstart;
  BOOL workend_option;
  j2735DDateTime workend;
} j2735RoadWorkInfo_KOR;


extern const ASN1CType asn1_type_j2735RoadWorkInfo_KOR[];

typedef struct j2735EventOrSvcInfo_KOR_1 {
  ASN1String *tab;
  size_t count;
} j2735EventOrSvcInfo_KOR_1;

extern const ASN1CType asn1_type_j2735EventOrSvcInfo_KOR_1[];

typedef struct j2735EventOrSvcInfo_KOR_2 {
  ASN1String *tab;
  size_t count;
} j2735EventOrSvcInfo_KOR_2;

extern const ASN1CType asn1_type_j2735EventOrSvcInfo_KOR_2[];

typedef struct j2735EventOrSvcInfo_KOR {
  BOOL typeEvent_option;
  j2735ITIScodes typeEvent;
  BOOL description_option;
  j2735ITIScodesAndText description;
  BOOL text_option;
  j2735EventOrSvcInfo_KOR_1 text;
  BOOL subtext_option;
  j2735EventOrSvcInfo_KOR_2 subtext;
} j2735EventOrSvcInfo_KOR;


extern const ASN1CType asn1_type_j2735EventOrSvcInfo_KOR[];

typedef enum j2735MsgType_KOR {
  j2735MsgType_KOR_bsm,
  j2735MsgType_KOR_spat,
  j2735MsgType_KOR_tls,
  j2735MsgType_KOR_map,
  j2735MsgType_KOR_nmeacorrection,
  j2735MsgType_KOR_rtcmcorrection,
  j2735MsgType_KOR_pvd,
  j2735MsgType_KOR_pdm,
  j2735MsgType_KOR_rsa,
  j2735MsgType_KOR_tim,
  j2735MsgType_KOR_adas,
  j2735MsgType_KOR_psm,
  j2735MsgType_KOR_drowsiness,
} j2735MsgType_KOR;

extern const ASN1CType asn1_type_j2735MsgType_KOR[];

typedef enum j2735MsgCommType_KOR {
  j2735MsgCommType_KOR_unavailable,
  j2735MsgCommType_KOR_wave,
  j2735MsgCommType_KOR_lte_4G,
  j2735MsgCommType_KOR_lte_5G,
  j2735MsgCommType_KOR_lte_v2x_rel14,
  j2735MsgCommType_KOR_lte_v2x_rel15,
  j2735MsgCommType_KOR_lte_v2x_rel16,
  j2735MsgCommType_KOR_lte_v2x_rel17,
  j2735MsgCommType_KOR_lte_v2x_rel18,
  j2735MsgCommType_KOR_lte_v2x_rel19,
  j2735MsgCommType_KOR_lte_v2x_rel20,
} j2735MsgCommType_KOR;

extern const ASN1CType asn1_type_j2735MsgCommType_KOR[];

typedef int j2735MsgChannel_KOR;

extern const ASN1CType asn1_type_j2735MsgChannel_KOR[];

typedef enum j2735MsgDeviceType_KOR {
  j2735MsgDeviceType_KOR_other,
  j2735MsgDeviceType_KOR_communication,
  j2735MsgDeviceType_KOR_display,
  j2735MsgDeviceType_KOR_adas,
  j2735MsgDeviceType_KOR_drowsinessDetector,
} j2735MsgDeviceType_KOR;

extern const ASN1CType asn1_type_j2735MsgDeviceType_KOR[];

typedef int j2735MsgDisplayLocation_KOR;

extern const ASN1CType asn1_type_j2735MsgDisplayLocation_KOR[];

typedef struct j2735MsgLog_KOR {
  j2735FurtherInfoID furtherInfoID;
  j2735MsgType_KOR msgType;
  BOOL msgEvent_option;
  j2735ITISCodes_KOR msgEvent;
  j2735TemporaryID msgID;
  BOOL msgDate_option;
  j2735DDateTime msgDate;
  BOOL msgCommType_option;
  j2735MsgCommType_KOR msgCommType;
  BOOL msgChannel_option;
  j2735MsgChannel_KOR msgChannel;
  j2735MsgDeviceType_KOR msgDeviceType;
  BOOL msgDisplayLocation_option;
  j2735MsgDisplayLocation_KOR msgDisplayLocation;
  BOOL msgDisplayTime_option;
  j2735DDateTime msgDisplayTime;
} j2735MsgLog_KOR;


extern const ASN1CType asn1_type_j2735MsgLog_KOR[];

typedef struct j2735MsgLogs_KOR_1 {
  j2735MsgLog_KOR *tab;
  size_t count;
} j2735MsgLogs_KOR_1;

extern const ASN1CType asn1_type_j2735MsgLogs_KOR_1[];

typedef struct j2735MsgLogs_KOR_2 {
  j2735MsgLog_KOR *tab;
  size_t count;
} j2735MsgLogs_KOR_2;

extern const ASN1CType asn1_type_j2735MsgLogs_KOR_2[];

typedef struct j2735MsgLogs_KOR {
  BOOL rcvMsgs_option;
  j2735MsgLogs_KOR_1 rcvMsgs;
  BOOL sndMsgs_option;
  j2735MsgLogs_KOR_2 sndMsgs;
} j2735MsgLogs_KOR;


extern const ASN1CType asn1_type_j2735MsgLogs_KOR[];

typedef enum j2735VehicleControlMode_KOR {
  j2735VehicleControlMode_KOR_manual,
  j2735VehicleControlMode_KOR_Auto,
} j2735VehicleControlMode_KOR;

extern const ASN1CType asn1_type_j2735VehicleControlMode_KOR[];

typedef enum j2735PossibleTurn_KOR {
  j2735PossibleTurn_KOR_none,
  j2735PossibleTurn_KOR_left_turn,
  j2735PossibleTurn_KOR_right_turn,
  j2735PossibleTurn_KOR_both_turn,
} j2735PossibleTurn_KOR;

extern const ASN1CType asn1_type_j2735PossibleTurn_KOR[];

typedef struct j2735VehicleControlInfo_KOR {
  BOOL mode_option;
  j2735VehicleControlMode_KOR mode;
  BOOL turning_option;
  j2735PossibleTurn_KOR turning;
  BOOL angle_option;
  j2735DrivingWheelAngle angle;
} j2735VehicleControlInfo_KOR;


extern const ASN1CType asn1_type_j2735VehicleControlInfo_KOR[];

typedef enum j2735DrivingStatus_KOR {
  j2735DrivingStatus_KOR_stop,
  j2735DrivingStatus_KOR_forward_moving,
  j2735DrivingStatus_KOR_backward_moving,
  j2735DrivingStatus_KOR_straight,
  j2735DrivingStatus_KOR_left_turning,
  j2735DrivingStatus_KOR_right_turning,
  j2735DrivingStatus_KOR_parking,
} j2735DrivingStatus_KOR;

extern const ASN1CType asn1_type_j2735DrivingStatus_KOR[];

typedef struct j2735FuelEfficiency_KOR {
  BOOL vehicleMileage_option;
  ASN1Integer vehicleMileage;
  BOOL evMileage_option;
  ASN1Integer evMileage;
} j2735FuelEfficiency_KOR;


extern const ASN1CType asn1_type_j2735FuelEfficiency_KOR[];

typedef struct j2735FuelResidualQuantity_KOR {
  BOOL vehiclePercent_option;
  int vehiclePercent;
  BOOL evPercent_option;
  int evPercent;
} j2735FuelResidualQuantity_KOR;


extern const ASN1CType asn1_type_j2735FuelResidualQuantity_KOR[];

typedef struct j2735FuelTankCapacity_KOR {
  BOOL fuelCapacity_option;
  int fuelCapacity;
  BOOL evCapacity_option;
  int evCapacity;
} j2735FuelTankCapacity_KOR;


extern const ASN1CType asn1_type_j2735FuelTankCapacity_KOR[];

typedef struct j2735FuelStatus_KOR {
  BOOL efficiency_option;
  j2735FuelEfficiency_KOR efficiency;
  BOOL residualQuantity_option;
  j2735FuelResidualQuantity_KOR residualQuantity;
  BOOL tankCapacity_option;
  j2735FuelTankCapacity_KOR tankCapacity;
} j2735FuelStatus_KOR;


extern const ASN1CType asn1_type_j2735FuelStatus_KOR[];

typedef int j2735Rpm_KOR;

extern const ASN1CType asn1_type_j2735Rpm_KOR[];

typedef struct j2735GyroscopeValue_KOR {
  BOOL xmax_option;
  int xmax;
  BOOL xmin_option;
  int xmin;
  ...
  BOOL zavg_option;
  int zavg;
} j2735GyroscopeValue_KOR;


extern const ASN1CType asn1_type_j2735GyroscopeValue_KOR[];

typedef struct j2735SensorValuesRegardingDriving_KOR {
  BOOL rpm_option;
  j2735Rpm_KOR rpm;
  BOOL gears_option;
  j2735TransmissionState gears;
  BOOL gyro_option;
  j2735GyroscopeValue_KOR gyro;
} j2735SensorValuesRegardingDriving_KOR;


extern const ASN1CType asn1_type_j2735SensorValuesRegardingDriving_KOR[];

typedef struct j2735ProbeVehicleData_KOR {
  int msgID;
  j2735DectLane_KOR curlane;
  BOOL adas_option;
  j2735CITSADAS_KOR adas;
  BOOL driverStatus_option;
  j2735HumanDriverStatus_KOR driverStatus;
  BOOL deviceStatus_option;
  j2735DeviceStatus_KOR deviceStatus;
  BOOL transitStatus_option;
  j2735TransitVehicleStatus transitStatus;
  BOOL transitOccupancy_option;
  j2735TransitVehicleOccupancy transitOccupancy;
  BOOL roadWorkInfo_option;
  j2735RoadWorkInfo_KOR roadWorkInfo;
  BOOL eventOrSvcInfo_option;
  j2735EventOrSvcInfo_KOR eventOrSvcInfo;
  BOOL msgLogs_option;
  j2735MsgLogs_KOR msgLogs;
  BOOL vehicleControlInfo_option;
  j2735VehicleControlInfo_KOR vehicleControlInfo;
  BOOL drivingStatus_option;
  j2735DrivingStatus_KOR drivingStatus;
  BOOL fuelStatus_option;
  j2735FuelStatus_KOR fuelStatus;
  BOOL sensorValues_option;
  j2735SensorValuesRegardingDriving_KOR sensorValues;
} j2735ProbeVehicleData_KOR;


extern const ASN1CType asn1_type_j2735ProbeVehicleData_KOR[];

typedef struct j2735RoadSideAlert_KOR_1 {
  j2735RegionDescribedByID_KOR *tab;
  size_t count;
} j2735RoadSideAlert_KOR_1;

extern const ASN1CType asn1_type_j2735RoadSideAlert_KOR_1[];

typedef struct j2735DetectedObject_KOR {
  ASN1String objectID;
  BOOL objectType_option;
  j2735ITIScodes objectType;
  j2735FullPositionVector objectLocation;
} j2735DetectedObject_KOR;


extern const ASN1CType asn1_type_j2735DetectedObject_KOR[];

typedef struct j2735DetectedObjectList_KOR {
  j2735DetectedObject_KOR *tab;
  size_t count;
} j2735DetectedObjectList_KOR;

extern const ASN1CType asn1_type_j2735DetectedObjectList_KOR[];

typedef struct j2735DetectedObjectInfo_KOR {
  ASN1String detectorID;
  j2735DetectedObjectList_KOR objects;
} j2735DetectedObjectInfo_KOR;


extern const ASN1CType asn1_type_j2735DetectedObjectInfo_KOR[];

typedef struct j2735RoadSideAlert_KOR {
  BOOL msgID_option;
  int msgID;
  BOOL regions_option;
  j2735RoadSideAlert_KOR_1 regions;
  BOOL events_option;
  j2735EventOrSvcInfo_KOR events;
  BOOL state_option;
  j2735MovementEvent state;
  BOOL detectedObject_option;
  j2735DetectedObjectInfo_KOR detectedObject;
} j2735RoadSideAlert_KOR;


extern const ASN1CType asn1_type_j2735RoadSideAlert_KOR[];

typedef BOOL j2735Disabled_KOR;

extern const ASN1CType asn1_type_j2735Disabled_KOR[];

typedef struct j2735RidingNotification_KOR {
  BOOL stopID_option;
  ASN1String stopID;
  BOOL disabled_option;
  j2735Disabled_KOR disabled;
  BOOL boarding_option;
  BOOL boarding;
} j2735RidingNotification_KOR;


extern const ASN1CType asn1_type_j2735RidingNotification_KOR[];

typedef struct j2735WeatherInfo_KOR {
  BOOL temp_option;
  j2735AmbientAirTemperature temp;
  BOOL rainfall_option;
  j2735EssPrecipRate rainfall;
  BOOL humidity_option;
  int humidity;
  BOOL windDir_option;
  j2735HeadingSlice windDir;
  BOOL windSpd_option;
  int windSpd;
} j2735WeatherInfo_KOR;


extern const ASN1CType asn1_type_j2735WeatherInfo_KOR[];

typedef enum j2735HighwayDirection_KOR {
  j2735HighwayDirection_KOR_up,
  j2735HighwayDirection_KOR_down,
  j2735HighwayDirection_KOR_upAndDown,
} j2735HighwayDirection_KOR;

extern const ASN1CType asn1_type_j2735HighwayDirection_KOR[];

typedef enum j2735FuelType_KOR {
  j2735FuelType_KOR_gasoline,
  j2735FuelType_KOR_diesel,
  j2735FuelType_KOR_lpg,
  j2735FuelType_KOR_premium,
  j2735FuelType_KOR_hydrogen,
  j2735FuelType_KOR_normalCharging,
  j2735FuelType_KOR_quickCharging,
  j2735FuelType_KOR_supercharging,
} j2735FuelType_KOR;

extern const ASN1CType asn1_type_j2735FuelType_KOR[];

typedef struct j2735StationInformation_KOR {
  j2735FuelType_KOR type;
  BOOL capacity_option;
  int capacity;
  BOOL maxcapacity_option;
  int maxcapacity;
  BOOL price_option;
  ASN1Integer price;
} j2735StationInformation_KOR;


extern const ASN1CType asn1_type_j2735StationInformation_KOR[];

typedef struct j2735ServiceAreaInformation_KOR_1 {
  j2735StationInformation_KOR *tab;
  size_t count;
} j2735ServiceAreaInformation_KOR_1;

extern const ASN1CType asn1_type_j2735ServiceAreaInformation_KOR_1[];

typedef enum j2735ParkingType_KOR {
  j2735ParkingType_KOR_normal,
  j2735ParkingType_KOR_disable,
  j2735ParkingType_KOR_big,
  j2735ParkingType_KOR_compact,
  j2735ParkingType_KOR_emergency,
  j2735ParkingType_KOR_women,
  j2735ParkingType_KOR_etc,
} j2735ParkingType_KOR;

extern const ASN1CType asn1_type_j2735ParkingType_KOR[];

typedef struct j2735ParkingCapacity_KOR {
  j2735ParkingType_KOR type;
  ASN1Integer numberOfParkingSpace;
  BOOL maxParkingSpace_option;
  ASN1Integer maxParkingSpace;
} j2735ParkingCapacity_KOR;


extern const ASN1CType asn1_type_j2735ParkingCapacity_KOR[];

typedef struct j2735ParkingZoneInformation_KOR_1 {
  j2735ParkingCapacity_KOR *tab;
  size_t count;
} j2735ParkingZoneInformation_KOR_1;

extern const ASN1CType asn1_type_j2735ParkingZoneInformation_KOR_1[];

typedef struct j2735ParkingZoneInformation_KOR {
  BOOL name_option;
  ASN1String name;
  BOOL id_option;
  ASN1String id;
  j2735ParkingZoneInformation_KOR_1 capacity;
} j2735ParkingZoneInformation_KOR;


extern const ASN1CType asn1_type_j2735ParkingZoneInformation_KOR[];

typedef struct j2735ServiceAreaInformation_KOR_2 {
  j2735ParkingZoneInformation_KOR *tab;
  size_t count;
} j2735ServiceAreaInformation_KOR_2;

extern const ASN1CType asn1_type_j2735ServiceAreaInformation_KOR_2[];

typedef struct j2735ServiceAreaInformation_KOR {
  ASN1String name;
  ASN1String id;
  j2735HighwayDirection_KOR direction;
  BOOL stationInfo_option;
  j2735ServiceAreaInformation_KOR_1 stationInfo;
  BOOL parkingInfo_option;
  j2735ServiceAreaInformation_KOR_2 parkingInfo;
} j2735ServiceAreaInformation_KOR;


extern const ASN1CType asn1_type_j2735ServiceAreaInformation_KOR[];

typedef enum j2735TollgateType_KOR {
  j2735TollgateType_KOR_general,
  j2735TollgateType_KOR_hipass,
  j2735TollgateType_KOR_truck_hipass,
  j2735TollgateType_KOR_multi_hipass_2,
  j2735TollgateType_KOR_multi_hipass_3,
  j2735TollgateType_KOR_multi_hipass_4,
  j2735TollgateType_KOR_multi_hipass_5,
  j2735TollgateType_KOR_multi_hipass_6,
  j2735TollgateType_KOR_multi_hipass_7,
  j2735TollgateType_KOR_multi_hipass_8,
  j2735TollgateType_KOR_multi_hipass_9,
  j2735TollgateType_KOR_multi_hipass_10,
} j2735TollgateType_KOR;

extern const ASN1CType asn1_type_j2735TollgateType_KOR[];

typedef struct j2735TollgateLane_KOR {
  BOOL laneNo_option;
  j2735DectLane_KOR laneNo;
  BOOL linkID_option;
  j2735LaneID linkID;
  BOOL type_option;
  j2735TollgateType_KOR type;
  BOOL open_option;
  BOOL open;
} j2735TollgateLane_KOR;


extern const ASN1CType asn1_type_j2735TollgateLane_KOR[];

typedef struct j2735TollgateLaneInformation_KOR_1 {
  j2735TollgateLane_KOR *tab;
  size_t count;
} j2735TollgateLaneInformation_KOR_1;

extern const ASN1CType asn1_type_j2735TollgateLaneInformation_KOR_1[];

typedef struct j2735TollgateLaneInformation_KOR {
  BOOL name_option;
  ASN1String name;
  BOOL heading_option;
  j2735HighwayDirection_KOR heading;
  BOOL lanes_option;
  j2735TollgateLaneInformation_KOR_1 lanes;
} j2735TollgateLaneInformation_KOR;


extern const ASN1CType asn1_type_j2735TollgateLaneInformation_KOR[];

typedef struct j2735TravelerDataFrameAdditionalInformation_KOR {
  int dataFrameIndex;
  BOOL events_option;
  j2735EventOrSvcInfo_KOR events;
  BOOL vehicleRidingStatus_option;
  j2735RidingNotification_KOR vehicleRidingStatus;
  BOOL weatherInfo_option;
  j2735WeatherInfo_KOR weatherInfo;
  BOOL serviceArea_option;
  j2735ServiceAreaInformation_KOR serviceArea;
  BOOL tollgate_option;
  j2735TollgateLaneInformation_KOR tollgate;
} j2735TravelerDataFrameAdditionalInformation_KOR;


extern const ASN1CType asn1_type_j2735TravelerDataFrameAdditionalInformation_KOR[];

typedef struct j2735TravelerInformation_KOR_1 {
  j2735TravelerDataFrameAdditionalInformation_KOR *tab;
  size_t count;
} j2735TravelerInformation_KOR_1;

extern const ASN1CType asn1_type_j2735TravelerInformation_KOR_1[];

typedef struct j2735TravelerInformation_KOR {
  BOOL msgID_option;
  ASN1Integer msgID;
  BOOL additionalInfo_option;
  j2735TravelerInformation_KOR_1 additionalInfo;
} j2735TravelerInformation_KOR;


extern const ASN1CType asn1_type_j2735TravelerInformation_KOR[];

typedef struct j2735PersonalSafetyMessage_KOR {
  BOOL path_option;
  j2735PathPlanned_KOR path;
} j2735PersonalSafetyMessage_KOR;


extern const ASN1CType asn1_type_j2735PersonalSafetyMessage_KOR[];

#ifdef  __cplusplus
}
#endif

#endif /* _FFASN1_FFASN1_J2735_2026_H */
